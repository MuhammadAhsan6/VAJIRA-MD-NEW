...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=2JswBbDS#JvWHCsQ1MpI_6Cdhaz2POSVLMJvYNsWYvNevBaMMD9s',
OWNER_NUMBER: process.env.OWNER_NUMBER || '923076360130'=== undefined ? '' : process.env.OWNER_NUMBER,   
